...
if(CXM_IS_CUDA_AVAILABLE)
    ...
    >)
    # for debug mode
    add_compile_options($<$<AND:$<COMPILE_LANGUAGE:CUDA>,$<CONFIG:Debug>>:
...
if(CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang")
    ...
    >)
    # for gcc debug mode
    add_compile_options($<$<AND:$<COMPILE_LANGUAGE:CXX>,$<CONFIG:Debug>>:
    ...
    add_compile_options($<$<AND:$<COMPILE_LANGUAGE:CXX>,$<CONFIG:Release>>:
