...
Sequential::Sequential(const std::initializer_list<std::unique_ptr<nn::Layer>> _layers) {
    this->layers_ = _layers;
}

void Sequential::train(std::vector<tensor> &_x, std::vector<tensor> &_y, int epochs, int batchSize) {
