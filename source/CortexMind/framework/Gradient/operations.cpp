...
addition::addition(const std::shared_ptr<TensorStorage> &tx_stor, const std::shared_ptr<TensorStorage> &ty_stor, const std::shared_ptr<TensorStorage> &tx_grad, const std::shared_ptr<TensorStorage> &ty_grad) : GradientFlow(1) {
