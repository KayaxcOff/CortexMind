...
namespace cortex::_fw::cuda {
    ...
    struct Activation {
         ...
         */
        static void relu(const f32* __restrict__ Xx, f32* __restrict__ Xz, size_t N);
         ...
         */
        static void leaky_relu(const f32* __restrict__ Xx, f32* __restrict Xz, size_t N, f32 alpha = 0.01f);

        /**
         * @brief Sigmoid activation: `Z[i] = 1 / (1 + e^(-X[i]))`
         */
        static void sigmoid(const f32* __restrict__ Xx, f32* __restrict__ Xz, size_t N);

        /**
         * @brief Fast Sigmoid approximation.
         */
        static void sigmoid_fast(const f32* __restrict__ Xx, f32* __restrict__ Xz, size_t N);

        /**
         * @brief Hyperbolic tangent activation: `Z[i] = tanh(X[i])`
         */
        static void tanh(const f32* __restrict__ Xx, f32* __restrict__ Xz, size_t N);

        /**
         * @brief GELU activation (tanh-based approximation).
         */
        static void gelu(const f32* __restrict__ Xx, f32* __restrict__ Xz, size_t N);

        /**
         * @brief GELU activation using erf function (more numerically accurate).
         */
        static void gelu_exact(const f32* __restrict__ Xx, f32* __restrict__ Xz, size_t N);

        /**
         * @brief SiLU (Swish with β=1) activation: `Z[i] = X[i] * sigmoid(X[i])`
         */
        static void silu(const f32* __restrict__ Xx, f32* __restrict__ Xz, size_t N);

        /**
         * @brief Fast SiLU approximation.
         */
        static void silu_fast(const f32* __restrict__ Xx, f32* __restrict__ Xz, size_t N);
         ...
         */
        static void swish(const f32* __restrict__ Xx, f32* __restrict__ Xz, size_t N, f32 beta = 1.0f);
         ...
         * @param beta Scaling parameter (default = 1.0)
         */
        static void swish_fast(const f32* __restrict__ Xx, f32* __restrict__ Xz, size_t N, f32 beta = 1.0f);
    };
} //namespace cortex::_fw::cuda
